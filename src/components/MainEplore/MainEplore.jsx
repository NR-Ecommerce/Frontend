  ...
  return (
    <div className='mainEplore'>
      <div className="mainEplore__numbers">
        ...
        <img src='https://chisnghiax.com/ciseco/static/media/explore1.3017824afbd558dae323.png' className="mainEplore__pic"/>
      </div>
      <div className="mainEplore__titles">
        <div className="mainEplore__dec">کیف خوب</div>
        <div className="mainEplore__title">کیف</div>
      </div>
      <div className="mainEplore__see">مشاهده کالکشن
      <BsArrowLeft/></div>
