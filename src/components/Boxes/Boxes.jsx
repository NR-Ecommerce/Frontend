...
const Boxes = () => {
  return (
    <div className="Boxes__notes">
      <div
        style={{ backgroundColor: "#FeF2F2" }}
        className="Boxes__note"
      >
        <div className="Boxes__note-icon">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <div className="Boxes__note-title">ارسال رایگان</div>
        <div className="Boxes__note-dec">
          برای خرید بالای 100,000 تومان
        </div>
      </div>
      <div
      ...
      >
        ...
        <div className="Boxes__note-title">بازگشت اسان</div>
        <div className="Boxes__note-dec">به هر دلیلی</div>
      </div>
      <div
      ...
      >
        ...
        <div className="Boxes__note-title">ارسال پیشتاز</div>
        <div className="Boxes__note-dec">در صورت خواست مشتری</div>
      </div>
      <div
      ...
      >
        ...
        <div className="Boxes__note-title">بازگشت وجه</div>
        <div className="Boxes__note-dec">
          تا 60 روز در صورت وجود هر مشکل
        </div>
      </div>
    </div>
  );
